...
public class ShipDetail {
	...
	public ShipDetail(String shipname, double longitude, double latitude,
	...
	public ShipDetail(int id, String shipname, double longitude,
			double latitude, double speed, double cruisedirection,
			double shipdirection, Date shipdate, String ais, String gps,
			int messagetype, int shiptype, Date adddate) {
		super();
		this.id = id;
		this.shipname = shipname;
		this.longitude = longitude;
